    ...
    var _initFilterNav = function () {
        $(".wallFilter").on('click', function (evt) {
           ...
           $(".wallFilter").find('i').not(checkboxi)
            ...
            if(filter_custom ==  'land'){
                $('#stream_lable').text('Land Stream')
            }
            if(filter_custom ==  'ocean'){
                $('#stream_lable').text('Ocean Stream')

            }if(filter_custom ==  'rjver'){
                $('#stream_lable').text('River Stream')
            }
